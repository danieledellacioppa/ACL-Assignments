...
where \emph{X} is the number in a subnetmask like \emph{Z.Y.W.X} which in this case will be

\[ 255 - 0\]

which returns 255 values but because we start counting from 0 we can go up to 254.
