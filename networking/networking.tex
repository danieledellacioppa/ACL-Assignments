...
\begin{itemize}
\item{\emph{All traffic from outside to inside, and vice versa, passes through the firewall}. Figure \ref{fig:firewall-placement} shows a firewall, sitting squarely at the boundary between the administered network and the rest of the Internet. While large organizations may use multiple levels of firewalls or distributed firewalls [Skoudis 2006], locating a firewall at a single access point to the network, as shown in Figure \ref{fig:firewall-placement}, makes it easier to manage and enforce a security-access policy.}
